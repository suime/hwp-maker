...
- [ ] 템플릿, 문서 변수, 프로필, 프로젝트가 각각 무엇을 책임지는지 정의
  ...
  - 문서 변수: YAML 변수 정의, 입력값, AI 생성값, 문서 치환
...
- [x] 브라우저 AI 설정 저장
- [ ] AI SDK 의존성 경로 정리
  - 현재 `/api/chat`과 `/api/template-ai`에서 `@ai-sdk/react` 하위의 `ai` dist를 직접 import
